                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        ...
                                        <a href="#LINK" onclick="javascript:fncAuthorInsert()" style="selector-dummy:expression(this.hideFocus=false);" class="btn btn_blue_46 w_100">저장</a><!-- 저장 -->
                                        </c:if>
                                        <c:if test="${registerFlag == 'UPDATE'}">
                                        <a href="#LINK" onclick="javascript:fncAuthorUpdate()" style="selector-dummy:expression(this.hideFocus=false);" class="btn btn_blue_46 w_100">저장</a><!-- 저장 -->
                                        <a href="#LINK" onclick="javascript:fncAuthorDelete()" style="selector-dummy:expression(this.hideFocus=false);" class="btn btn_blue_46 w_100">삭제</a><!-- 삭제 -->
                                        </c:if>
