                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view2">
                                    <table summary="배너정보를 입력하는 항목">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="f_file" type="file" name="file_1" id="egovComFileUploader" title="배너이미지" onchange="javascript:fncOnChangeImage();">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="lb">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="sortOrdr" id="sortOrdr" class="f_txt w_130" type="text" title="정렬순서" value="<c:out value='${banner.sortOrdr}'/>" maxLength="5" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="regDate" id="regDate" class="f_txt" title="등록일시" type="text" value="<c:out value="${banner.regDate}"/>" maxLength="20" readonly="readonly" >
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        <a href="#LINK" class="btn btn_blue_46 w_100" onclick="fncBannerInsert(); return false;"><spring:message code="button.save" /></a><!-- 저장 -->
