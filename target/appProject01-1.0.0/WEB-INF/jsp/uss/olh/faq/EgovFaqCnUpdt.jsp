                                ...
                                <div class="board_view">
                                    ...
                                    <div class="board_attach faqreg">
                                    	...
                                    	function fn_egov_deleteFile(atchFileId, fileSn) {
                                    	    ...
                                    	    var returnUrl = "<c:url value='/uss/olh/faq/FaqCnUpdtView.do'/>?faqId=" + encodeURIComponent(faqId);
                                    ...
                                    <div class="board_view_bot">
                                        ...
                                        <div class="right_col btn1">
                                        	<a href="#LINK" class="btn btn_blue_46 w_100" onclick="fn_egov_updt_faqcn(document.faqManageVO, document.faqManageVO.faqId.value); return false;"><spring:message code="button.save" /></a><!-- 저장 -->
