                    ...
                    <div class="layout">
                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
								...
								<form:form modelAttribute="qnaManageVO" name="qnaManageVO" action="${pageContext.request.contextPath}/uss/olh/qna/admin/QnaCnRegist.do" method="post" >
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        <a href="#LINK" class="btn btn_blue_46 w_100" onclick="fn_egov_regist_qnacn(document.qnaManageVO); return false;"><spring:message code="button.save" /></a><!-- 저장 -->
